  ...
  return (
    <div className='h-auto w-full flex flex-col '>
        <div className="h-auto w-full  p-10">
            <p className='text-xl text-black font-medium w-full flex justify-center items-center'>Message from</p>
            <p className='lg:text-4xl text-2xl text-black font-medium w-full flex justify-center items-center'>Our Chairman & Director</p>
